<head>
 <title>Labor Force Option 2</title>
...
echo "<h2> Option 2: Query labor force data by sorted by COVID data </h2>";
...
if ($mysqli->multi_query("CALL LaborForceCovid('".$topbottom."','".$number."','".$attribute."');")) {
