...
function outputResultsTableHeader() {
   echo "<tr>";
   echo "<th> Country </th>";
   echo "<th> GDP<br />($ millions) </th>";
   echo "<th> GDP Per Capita<br />($) </th>";
   echo "<th> Research and Development Expenditure<br />(% of GDP) </th>";
   echo "<th> Health Expenditure<br />(% of GDP) </th>";
...
echo "<h2> Option 3: Query data sorted by GDP data </h2>";
...
echo ($attribute == 'gdp') ? "GDP" : "";
echo ($attribute == 'gdpPerCapita') ? "GDP Per Capita" : "";
echo ($attribute == 'rdGDPExp') ? "Research and Development Expenditure" : "";
echo ($attribute == 'healthGDPExp') ? "Health Expenditure" : "";
echo "</h3>";
...
if ($mysqli->multi_query("CALL GDPThree('".$topbottom."','".$number."','".$attribute."');")) {
