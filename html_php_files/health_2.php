...
echo "<h2> Option 2: Query health data by sorted by COVID data </h2>";
...
if ($mysqli->multi_query("CALL HealthCovid('".$topbottom."','".$number."','".$attribute."');")) {
